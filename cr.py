...
# ==================================================================
__version__ = "6.89 (Fixed NameError and added 'by Run' report)"
# ==================================================================
...
def calculate_capacity_risk(_df_raw, toggle_filter, default_cavities, target_output_perc_slider, mode_ct_tolerance, rr_downtime_gap, run_interval_hours):
    ...
    for date, daily_df in df_rr.groupby('date'):
        ...
        # Get run breaks that happened *on this day*
                    ...
                    if df_day_shots.empty:
                        ...
                        st.dataframe(
                            df_day_shots[[
                                ...
                                'Working Cavities', 'run_id', 'Shot Type', 'stop_flag', # <-- v6g.89: Added run_id
